...
const AppLayout = ({ children }: AppLayoutProps) => {
  ...
  return (
    <div className="h-screen flex overflow-hidden bg-background">
      ...
      <aside
        className={cn(
          "fixed left-0 z-40 flex flex-col overflow-hidden transition-all duration-300 ease-in-out lg:relative lg:translate-x-0 lg:z-auto shrink-0 rounded-tr-2xl",
